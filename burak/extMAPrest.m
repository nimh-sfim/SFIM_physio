...
fileList = dir(fullfile(pwd, 'Log*_pulse*.csv'));
c=readtable(fileList.name); %load caretaker

fileList = dir(fullfile(pwd, '*CooperRest*.acq'));%Rest
...
fileList = dir(fullfile(pwd, 'Log*_vitals*.csv'));
