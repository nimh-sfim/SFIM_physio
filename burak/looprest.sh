...
# Loop through subjects from bp26 to bp34 and run afni_rest_function
for i in 34; do
    afni_proc.py -subj_id "bp${i}" \
        ...
        -dsets "/data/akinb2/allbp/bp${i}/rest.nii" \
        ...
        -out_dir "/data/akinb2/allbp/bp${i}/func_rest" \
        -script  "preproc_restbp${i}.sh" \
