...
# Loop through subjects from bp26 to bp34 and run afni_bouh_function
for i in 34; do
    afni_proc.py -subj_id "bp${i}" \
        ...
        -dsets "/data/akinb2/allbp/bp${i}/bouh.nii" \
        ...
        -out_dir "/data/akinb2/allbp/bp${i}/func_bouh" \
        -script  "preproc_bouhbp${i}.sh" \
