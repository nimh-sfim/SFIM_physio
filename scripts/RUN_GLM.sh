#!/bin/bash
# bash /mnt/d/BrainMOTOR-SCI/RUN_GLM_SCI.sh

# Combinations that I need to do: SCAN1 (pMVC, pMVCrelS1, force_abs), SCAN 2 (pMVC, pMVCrelS1, force_abs)
# Combinatinos that I've done: SCAN1 (pMVC, pMVCrelS1, force_abs), SCAN2 (pMVC, pMVCrelS1, Z)
