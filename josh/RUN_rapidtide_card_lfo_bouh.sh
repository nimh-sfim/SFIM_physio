#!/bin/bash
# bash RUN_rapidtide_card_lfo_bouh.sh
# sbatch --cpus-per-task=16 --mem=64g --time 60:00:00 RUN_rapidtide_card_lfo_bouh.sh
...
#for sbjid in "15"; do
    ...
    card_lfo_data=/data/SFIM_physio/physio/physio_results/sub${sbjid}/sub${sbjid}_lfo_downsampled2TR_arr_outhold.tsv
    out_prefix=sub${sbjid}_outhold_card_lfo_delay_1030
...
# if [ -f /data/SFIM_physio/data/bp32/func_binh/pb04.bp32.r01.scale.nii ]; then
#     echo "yes"
# fi
