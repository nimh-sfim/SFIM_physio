#!/bin/bash
# bash RUN_rapidtide_card_lfo_binh_singularity.sh
# for whatever reason, sbatch doesn't output stuff... BEWARE: sbatch --cpus-per-task=16 --mem=64g --time 60:00:00 RUN_rapidtide_card_lfo_binh_singularity.sh
...
#for sbjid in "11"; do
    ...
    basename_you_want_for_rapidtide_output=sub${sbjid}_inhold_card_lfo_delay_1030
    lfo_dir=/data/SFIM_physio/physio/physio_results/sub${sbjid}
    lfo_file=sub${sbjid}_lfo_downsampled2TR_arr_inhold_hdr.tsv
