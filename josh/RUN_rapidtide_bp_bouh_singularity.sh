#!/bin/bash
# bash RUN_rapidtide_bp_bouh_singularity.sh
# for whatever reason, sbatch doesn't output stuff... BEWARE: sbatch --cpus-per-task=16 --mem=64g --time 60:00:00 RUN_rapidtide_bp_bouh_singularity.sh
...
#for sbjid in "11"; do
    ...
    the_directory_with_input_nii=/data/SFIM_physio/data/bp${sbjid}/func_bouh
    ...
    basename_you_want_for_rapidtide_output=sub${sbjid}_outhold_MAP_delay_1030
    map_dir=/data/SFIM_physio/physio/physio_results/sub${sbjid}
    map_file=sub${sbjid}_MAP_downsampled2TR_arr_outhold_hdr.tsv
